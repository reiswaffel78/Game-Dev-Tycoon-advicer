...
import type { Genre, RecommendationResult } from "@shared/schema";
          ...
          {!selectedGenre ? (
            ...
            <div className="space-y-4">
              ...
              <NextStepCTA
                ...
                titleKey="nextStep.genreToPlatform.title"
                bodyKey="nextStep.genreToPlatform.body"
                dataCdaId="genre_to_platform"
              />
            </div>
          ) : (
            <Card>
